import d3 from 'd3';
var FormattingUtilities = require('../utilities/FormattingUtilities');
...
d3Chart.drawBars = function(el, scales, data, height) {
    ...
    var mouseOver = function(d) {
        ...
        var diff = FormattingUtilities.formatDollarAmount(d.value);
        var cur  = FormattingUtilities.formatDollarAmount(d.history[d.history.length-1]);
        var prev = FormattingUtilities.formatDollarAmount(d.history[d.history.length-2]);
